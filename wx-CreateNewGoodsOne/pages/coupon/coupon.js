...
Page({
  ...
  data: {
    ...
    per_page: 10,
    couponList1: [//优惠券
      { coupon: { amount: 100,text:"满100.00元可用", name: "立即使用", start_date: "2017-1-1", end_date:"2017-1-1"},status:1 },
      { coupon: { amount: 100,text:"满100.00元可用", name: "立即使用", start_date: "2017-1-1", end_date: "2017-1-1"}, status: 1 },
      { coupon: { amount: 100,text:"满100.00元可用", name: "已过期", start_date: "2017-1-1", end_date: "2017-1-1"}, status: 2 },
      { coupon: { amount: 100,text:"满100.00元可用", name: "已使用", start_date: "2017-1-1", end_date: "2017-1-1"}, status: 3 },
      { coupon: { amount: 100,text:"满100.00元可用", name: "已使用", start_date: "2017-1-1", end_date: "2017-1-1"}, status: 3 },
    ],
  ...
  getCouponList () {
    ...
    http.fxPost(api.user_coupons, params, function (res) {
      if (res.success) {
        ...
        console.log(res.data.coupons,99)
        that.setData({
